...
import { getFromLocalStorage, setToLocalStorage } from 'components/Constants/localStorage';

import { Container } from '../ContactList/Container.styled';

export function App() {
  const [contacts, setContacts] = useState(getFromLocalStorage('contacts') ?? baseContacts); 
